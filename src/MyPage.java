...
public class MyPage extends JFrame {
	...
	public MyPage() throws Exception {
		...
		btnNewButton_1.setBounds(276, 326, 89, 23);
		...
		btnNewButton_3.setIcon(new ImageIcon(MyPage.class.getResource("/images/icons8-delete-16.png")));
		btnNewButton_3.setBounds(571, 323, 89, 23);
		...
		JLabel lblCopyrightscThedeepanshumourya = new JLabel("Copyrights(c) Shiva.");
